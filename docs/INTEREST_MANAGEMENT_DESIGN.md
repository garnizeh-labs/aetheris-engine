...
| Q4 | **Cross-shard interest** | In federated deployments, how does interest span shard boundaries? | Addressed by FEDERATION_DESIGN (Not available yet) — entities are transferred, not cross-shard visible. |
