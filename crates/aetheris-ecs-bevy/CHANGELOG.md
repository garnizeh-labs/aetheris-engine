...
- *(engine)* Add AI behavioral markers and expand authoritative entity docs
- Integrate authoritative entity stats from protocol helper in BevyWorldAdapter

### 🚜 Refactor

- Simplify entity component insertion by hoisting default stat lookups and normalizing component initialization
## [0.10.1] - 2026-04-26

### 🚀 Features

- *(engine)* Sync with centralized entity definitions
## [0.10.0] - 2026-04-26
...
- *(engine)* Implement cargo collection and improve projectile combat logic
## [0.9.0] - 2026-04-25
