...
- Feature gate bootstrap_phase1_world to allow minimal feature builds
...
- *(engine)* Implement WebTransport first-message auth and fix clippy/test issues

### 🚜 Refactor

- *(engine)* Robustify webtransport auth and improve observability
## [0.10.2] - 2026-04-26
## [0.10.1] - 2026-04-26
